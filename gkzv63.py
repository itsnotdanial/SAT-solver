...
def simple_sat_solve(clause_set) :
    ...
    def tree(clause_set, assignment, Satis) :
        ...
        if finished == True :
            ...
            if leaf != False :
                return leaf
            return tree(clause_setS, assignment*-1, SAT2)
    Satis = []    
    val = tree(clause_set, clause_set[0][0], Satis)
    if val != False :
        return val
    
    return tree(clause_set, clause_set[0][0]*-1, Satis)
...
x = dpll_sat_solve(clause_set, partial_assignment)
print(x)
end = time.perf_counter()
print(end - start)
#x = simple_sat_solve(clause_set)
#x = branching_sat_solve(clause_set, partial_assignment)
